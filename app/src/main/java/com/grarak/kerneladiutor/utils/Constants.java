...
public interface Constants {
    ...
    String[] SCREEN_KCAL_CTRL_ARRAY = {SCREEN_KCAL_CTRL_CTRL, SCREEN_KCAL_CTRL_MIN,
    ...
    String[] DT2W_ARRAY = {LGE_TOUCH_DT2W, LGE_TOUCH_CORE_DT2W, DT2W, TOUCH_PANEL_DT2W, DT2W_WAKEUP_GESTURE};
