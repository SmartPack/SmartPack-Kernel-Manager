...
import com.smartpack.kernelmanager.utils.kernel.wake.Dt2s;
import com.smartpack.kernelmanager.utils.kernel.wake.Dt2w;
import com.smartpack.kernelmanager.utils.kernel.wake.Gestures;
import com.smartpack.kernelmanager.utils.kernel.wake.Misc;
import com.smartpack.kernelmanager.utils.kernel.wake.S2s;
import com.smartpack.kernelmanager.utils.kernel.wake.S2w;
import com.smartpack.kernelmanager.utils.kernel.wake.T2w;
...
import com.smartpack.kernelmanager.views.recyclerview.CheckBoxView;
...
public class WakeFragment extends RecyclerViewFragment {
    ...
    private void wakeInit(List<RecyclerViewItem> items) {
        ...
        if (mS2w.hasS2W()) {
            ...
            s2w.setTitle(getString(R.string.s2w));
            s2w.setSummary(getString(R.string.s2w_summary));
            s2w.setItems(mS2w.enableS2W(requireActivity()));
        ...
        if (mT2w.supported()) {
            ...
            t2w.setItems(mT2w.getMenu(requireActivity()));
        ...
        if (S2s.hasVibStrength()) {
            ...
            vibStrength.setProgress(S2s.getVibStrength());
                ...
                gesture.addOnSwitchListener((switchView, isChecked) -> {
                    ...
                    getHandler().postDelayed(() -> {
                                for (int i1 = 0; i1 < gestures.size(); i1++) {
                                    gesture.setChecked(Gestures.isEnabled(i1));
                                }},
                            500);
                });
        ...
        if (mMisc.hasSmartWake()) {
            ...
            smartWake.addOnSwitchListener((switchView, isChecked) -> {
